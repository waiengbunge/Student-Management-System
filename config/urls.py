...
urlpatterns = [
    ...
    path('accounts/tokens/', accounts_views.personal_tokens, name='personal_tokens'),
    path('accounts/tokens/create/', accounts_views.personal_tokens_create, name='personal_tokens_create'),
    path('accounts/tokens/<int:token_id>/delete/', accounts_views.personal_tokens_delete, name='personal_tokens_delete'),
